...
# Template: app
# Command: c:\Qt\4.8.4\bin\qmake.exe -o Makefile websis1.7.pro
#############################################################################
...
Makefile: websis1.7.pro  ../Qt/4.8.4/mkspecs/default/qmake.conf ../Qt/4.8.4/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -o Makefile websis1.7.pro
